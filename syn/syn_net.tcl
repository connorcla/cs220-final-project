...
set_clock_uncertainty 0.2 -setup [get_clocks "v_clk"]
set_clock_uncertainty 0.2 -hold [get_clocks "v_clk"]

# General design constraints
set_max_fanout 100 [get_designs "*"]
set_fix_multiple_port_nets -all -buffer_constants

set_input_transition 0.1 [get_ports "op_src[*]"]
set_input_transition 0.1 [get_ports "op_dst[*]"]
set_input_transition 0.1 [get_ports "inst_alu[*]"]

set_load 0.005 [get_ports "alu_out[*]"]
set_load 0.005 [get_ports "alu_stat[*]"]
