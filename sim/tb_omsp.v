...
module openMSP430_mini_tb;
    ...
    initial begin
        ...
        force uut.execution_unit_0.register_file_0.r5 = 16'h1111;
        force uut.execution_unit_0.register_file_0.r6 = 16'h2222;
        #10;
        release uut.execution_unit_0.register_file_0.r5;
        release uut.execution_unit_0.register_file_0.r6;

        // CPU fetch and execute
        repeat(10) @(posedge mclk);

        // Expected: 0x1111 + 0x2222 = 0x3333
        if (uut.execution_unit_0.register_file_0.r6 == 16'h3333)
            $display("SUCCESS: ADD Result is %h", uut.execution_unit_0.register_file_0.r6);
        else
            $display("FAILURE: ADD Result is %h (Expected 3333)", uut.execution_unit_0.register_file_0.r6);
